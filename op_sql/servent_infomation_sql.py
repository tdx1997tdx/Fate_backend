...
def servent_infomation(id,conn_info=c.conn3_info):
    ...
    dic_info["alignment"] = alignment_res[random.randint(0,len(alignment_res)-1)]
    ...
    dic_info["class"] = class_res[random.randint(0,len(class_res)-1)]
    ...
    dic_info["illustrator"] = illustrator_res[random.randint(0,len(illustrator_res)-1)]
    ...
    dic_info["voice_actor"] = voice_actor_res[random.randint(0,len(voice_actor_res)-1)]
